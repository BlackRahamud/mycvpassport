...
export default function CandidatesPage() {
  ...
  // Always open the chooser so a recruiter with zero jobs can still create a
  // sourcing pool and upload a batch on day one.
  const openAddCandidate = () => setPickerOpen(true);

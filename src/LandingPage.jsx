...
export default function LandingPage({ user, onSignOut, onLogin, onSignup, onWalkIn }) {
  ...
  // Smart CTA helpers — W18 landing body reads userType via the 5 block
  // components and their own hooks; what remains here feeds the nav chrome
  // (avatar initials, avatar dropdown destination, sign-out path).
  ...
  const handleLandingNav = (item) => {
    if (item === 'Templates') navigate('/templates');

  ...
  return (
    <>
      <Helmet>
        ...
        {/* Share card: the CURRENT chevron mark, 1200x630, regenerated by
            scripts/generate-og-image.mjs. This replaced the retired falcon
            logo (images/falcon-icon.png), which was still what LinkedIn and
            WhatsApp rendered. Width and height are declared so platforms lay
            the card out before the image finishes downloading. */}
        <meta property="og:image" content="https://www.mycvpassport.com/og-image.png" />
        <meta property="og:image:secure_url" content="https://www.mycvpassport.com/og-image.png" />
        <meta property="og:image:type" content="image/png" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta property="og:image:alt" content="CVPassport — ATS-ready CVs for UAE, Gulf and India jobs" />
        <meta property="og:site_name" content="CVPassport" />
        ...
        <meta name="twitter:image" content="https://www.mycvpassport.com/og-image.png" />
        <meta name="twitter:image:alt" content="CVPassport — ATS-ready CVs for UAE, Gulf and India jobs" />

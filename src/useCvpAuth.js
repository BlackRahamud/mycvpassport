...
export function useCvpAuth() {
  ...
  useEffect(() => {
    ...
    if (!["/", "/pricing", "/walk-in", "/builder", "/ats", "/cover-letter", "/dashboard", "/admin", "/account", "/templates", "/hr", "/dashboard/applications", "/linkedin-optimizer"].includes(clean) && !clean.startsWith("/jobs/")) {

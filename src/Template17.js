// ─────────────────────────────────────────────────────────────────
//  TEMPLATE 17 — Forest Pro
//  Full-width single-column, green header block. Preview + PDF.
// ─────────────────────────────────────────────────────────────────
...
const ACCENT = "#16A34A";
const SECTION_TITLE = "#14532D";
const COMPANY_COLOR = "#16A34A";
...
export function PreviewForestPro({ cv, mobileMode = false }) {
  ...
  return (
    ...
    >
      ...
      {/* Skills — inline bullet list with green dot */}
      {skillCore.length > 0 && (
          ...
          <div style={{ marginTop: "-4mm", breakInside: "auto", pageBreakInside: "auto" }}>
            <EntryWrap>
              <div>
                ...
                <p style={{ fontSize: pt(10), lineHeight: 1.8, margin: 0, color: BODY_COLOR }}>
      ...
      {/* Technical Skills — inline bullet list with green dot */}
      {techGroups.length > 0 && (
...
// ─── PDF: Forest Pro ────────────────────────────────────────────
export function pdfForestPro(doc, cv, W, M) {

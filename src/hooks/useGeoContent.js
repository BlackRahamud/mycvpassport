  ...
  return useMemo(() => {
    ...
    if (isIndia) {
      return {
        ...
        heroHeadlineHighlight: "shortlisted",
        heroHeadlineAfter: " in the Gulf.",
        subheadline: "ATS-engineered for banking, IT and corporate hiring portals — built for the way Indian and Gulf recruiters actually screen CVs.",
        cta: "Start my Gulf CV — Free →",
        ctaSecondary: "or explore templates",
    ...
    return {
      ...
      heroHeadlineBefore: "The CV that gets you ",
      heroHeadlineHighlight: "shortlisted",
      heroHeadlineAfter: " in the Gulf.",
      subheadline: "Built for the way Gulf employers actually hire. ATS-parsed, recruiter-approved, free to start.",

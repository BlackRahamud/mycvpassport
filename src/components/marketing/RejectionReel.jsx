...
const CANDIDATES = [
  { id:"c01", initials:"AM", first:"Ahmed",   role:"Senior Finance Analyst",   company:"Leading UAE Bank",     city:"Dubai",      flag:"🇦🇪", market:"UAE",    reason:"NO_KEYWORD_MATCH",     reasonLong:"Missing 14 of 18 required keywords",         score:34, fileKB:187 },
  { id:"c02", initials:"PR", first:"Priya",   role:"Digital Marketing Manager",company:"Indian Food Delivery App",           city:"Bengaluru",  flag:"🇮🇳", market:"IN",     reason:"FORMAT_UNPARSEABLE",   reasonLong:"Two-column layout broke the parser",          score:21, fileKB:312 },
  { id:"c03", initials:"RK", first:"Rajesh",  role:"IT Infrastructure Lead",   company:"Gulf Aviation Group",  city:"Abu Dhabi",  flag:"🇦🇪", market:"UAE",    reason:"NO_ACHIEVEMENTS",      reasonLong:"Job duties listed, zero quantified results",  score:41, fileKB:256 },
  { id:"c04", initials:"FH", first:"Fatima",  role:"Brand Strategist",         company:"GCC Ride-hailing App",           city:"Dubai",      flag:"🇦🇪", market:"UAE",    reason:"HEADER_IN_IMAGE",      reasonLong:"Name and contact stored as graphic, not text",score:18, fileKB:428 },
  { id:"c05", initials:"VS", first:"Vikram",  role:"Backend Engineer",         company:"Regional Fintech",         city:"Bengaluru",  flag:"🇮🇳", market:"IN",     reason:"GENERIC_SUMMARY",      reasonLong:"Summary matches 83% of applicant pool",       score:29, fileKB:198 },
  { id:"c06", initials:"NK", first:"Noura",   role:"HR Business Partner",      company:"Abu Dhabi Energy Co",            city:"Abu Dhabi",  flag:"🇦🇪", market:"UAE",    reason:"WRONG_SECTION_ORDER",  reasonLong:"Skills buried on page 3 — parser stopped",    score:38, fileKB:221 },
  { id:"c07", initials:"AS", first:"Arjun",   role:"Product Manager",          company:"Indian Payments Platform",            city:"Noida",      flag:"🇮🇳", market:"IN",     reason:"DATE_GAP_UNEXPLAINED", reasonLong:"18-month gap flagged, no context given",      score:43, fileKB:174 },
  { id:"c08", initials:"MA", first:"Maryam",  role:"Supply Chain Analyst",     company:"Regional Logistics Firm",           city:"Dubai",      flag:"🇦🇪", market:"UAE",    reason:"NO_KEYWORD_MATCH",     reasonLong:"Missing 11 of 15 required keywords",         score:31, fileKB:209 },
  { id:"c09", initials:"SI", first:"Sanjay",  role:"Data Scientist",           company:"Indian E-commerce Giant",         city:"Bengaluru",  flag:"🇮🇳", market:"IN",     reason:"PDF_SCAN_ONLY",        reasonLong:"File was scanned, not text-based PDF",         score:12, fileKB:892 },
  { id:"c10", initials:"OK", first:"Omar",    role:"Relationship Manager",     company:"Major UAE Bank",     city:"Dubai",      flag:"🇦🇪", market:"UAE",    reason:"NO_ACHIEVEMENTS",      reasonLong:"Responsibilities only — no measurable impact",score:37, fileKB:244 },
  { id:"c11", initials:"DH", first:"Deepak",  role:"DevOps Engineer",          company:"Indian Food-tech Platform",           city:"Gurgaon",    flag:"🇮🇳", market:"IN",     reason:"FORMAT_UNPARSEABLE",   reasonLong:"Tables caused column data to merge",          score:24, fileKB:301 },
  { id:"c12", initials:"LK", first:"Layla",   role:"Marketing Director",       company:"Gulf Retail Conglomerate", city:"Dubai",      flag:"🇦🇪", market:"UAE",    reason:"TITLE_MISMATCH",       reasonLong:"Applied for Director — CV says Manager",      score:45, fileKB:267 },
  { id:"c13", initials:"KN", first:"Kavya",   role:"UX Designer",              company:"Indian Ed-tech Platform",           city:"Bengaluru",  flag:"🇮🇳", market:"IN",     reason:"NO_PORTFOLIO",         reasonLong:"Portfolio URL missing — auto-rejected",       score:48, fileKB:201 },
  { id:"c14", initials:"HB", first:"Hassan",  role:"Operations Supervisor",    company:"Luxury Hospitality Group",   city:"Dubai",      flag:"🇦🇪", market:"UAE",    reason:"GENERIC_SUMMARY",      reasonLong:"Summary too broad — no role match",           score:33, fileKB:192 },
  { id:"c15", initials:"MP", first:"Meera",   role:"Investment Analyst",       company:"Leading Indian Bank",        city:"Mumbai",     flag:"🇮🇳", market:"IN",     reason:"FONT_EMBEDDED",        reasonLong:"Decorative font couldn't be read by ATS",     score:27, fileKB:234 },
  { id:"c16", initials:"YK", first:"Yousef",  role:"Commercial Manager",       company:"UAE Retail Group",       city:"Dubai",      flag:"🇦🇪", market:"UAE",    reason:"NO_KEYWORD_MATCH",     reasonLong:"Missing 9 of 12 domain keywords",            score:39, fileKB:215 },
];

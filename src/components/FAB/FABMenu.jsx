  ...
  if (kind === "info") {
    return (
      <svg width={14} height={14} viewBox="0 0 24 24" fill="none" aria-hidden>
        <circle cx="12" cy="12" r="9" style={{ stroke }} strokeWidth={sw} />
        <path d="M12 10v8M12 7h.01" style={{ stroke }} strokeWidth={sw} strokeLinecap="round" />
      </svg>
    );
  }
  if (kind === "eye") {
    return (
      <svg width={14} height={14} viewBox="0 0 24 24" fill="none" aria-hidden>
        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" style={{ stroke }} strokeWidth={sw} />
        <circle cx="12" cy="12" r="3" style={{ stroke }} strokeWidth={sw} />
      </svg>
    );
  }
  if (kind === "arrow") {
    return (
      <svg width={14} height={14} viewBox="0 0 24 24" fill="none" aria-hidden>
        <path d="M5 12h14M12 5l7 7-7 7" style={{ stroke }} strokeWidth={sw} strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    );
  }
  /* spark */

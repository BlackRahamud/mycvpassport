...
const S = {
  ...
  panel: {
    ...
    maxHeight: 322,
    overflowY: "auto",
    /* Real glass — this listbox genuinely floats over the form. */
    background: "var(--builder-glass, var(--bg-elevated, #1C1C1C))",
    backdropFilter: "blur(32px) saturate(1.8)",
    WebkitBackdropFilter: "blur(32px) saturate(1.8)",
    border: "1px solid var(--builder-glass-border, var(--border, #2A2A2A))",
    borderRadius: 12,
    padding: 6,
    boxShadow: "var(--builder-glass-shadow, 0 16px 48px -16px rgba(0,0,0,0.55))",
    scrollbarWidth: "thin",
  },
  ...
  sheet: {
    ...
    boxShadow: "var(--builder-glass-shadow, 0 -18px 50px -20px rgba(0,0,0,0.6))",

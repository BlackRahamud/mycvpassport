// ─────────────────────────────────────────────────────────────────
//  TEMPLATE 16 — Crimson Edge
//  Full-width single-column, dark header with left red accent bar. Preview + PDF.
// ─────────────────────────────────────────────────────────────────
...
const ACCENT = "#DC2626";
const SECTION_TITLE = "#0F0F0F";
const COMPANY_COLOR = "#DC2626";
...
// ─── PDF: Crimson Edge ──────────────────────────────────────────
export function pdfCrimsonEdge(doc, cv, W, M) {
  ...
  doc.text(cv.name || "Your Name", M + 4, y);
  y += 6;
  ...
  if (cv.title) {
    ...
    doc.text(cv.title.toUpperCase(), M + 4, y);
    y += 5;
  }
